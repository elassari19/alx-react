...
describe('<WithLogging />', () => {
	...
	it(`should tests that console.log contains 'Component' on mount when wrapped element is PURE html`, () => {
		console.log = jest.fn();
	...
	it(`should tests that console.log contains name of wrapped element when mounted or unmounted`, () => {
		console.log = jest.fn();
		const Example = WithLoggingHOC(() => <p>Component</p>);
		const wrapper = mount(<Example />);
		expect(console.log).toHaveBeenCalledWith('Component Component was mounted');
